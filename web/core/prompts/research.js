...

{
  ...
  "campaign_facts": ["operational facts stated in the sources that later passes need: budget, KPI targets, dates, landing page, mandatory CTA, channels to exclude, sign-off owners. Verbatim where possible. Empty if none."],
...
Campaign facts (budget, targets, dates, mandatories; use these, do not invent others):
${list(ctx.campaign_facts)}
