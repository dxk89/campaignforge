...
module.exports = {
  ...
  schema: {
    ...
    properties: {
      ...
      measurement: { type: 'object', properties: { kpi_tree: { type: 'array' }, funnel: { type: 'array' }, reporting_cadence: { type: 'string' }, data_quality: { type: 'array' } }, required: ['kpi_tree', 'funnel', 'reporting_cadence', 'data_quality'] },
